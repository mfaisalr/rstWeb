			...
			<div class="container">
				<div class="row">
						...
						<div class="blog-posts">
							<div class="blog-post">
								<div class="blog-post-info">
									<div>
										<h2 class="post-title"><a href="../../../tentang_kami/detail/sejarah">Sejarah</a></h2>
									</div>
								</div>
                                ...
                                <div class="row">
									<div class="col-md">
										<img src="../../../images/blog/rst_dulu.png" class="img-fluid" alt="">
									</div>
									<div class="col-md mt-2 mt-md-0">
										<p><b>Rumah Sakit Dr. R. Hardjanto</b> merupakan Rumah Sakit  militer Belanda di Balikpapan yang di perkirakan berdiri pada pertengahan tahun 1945 yang di kepalai oleh Kapten. Dr. V. De Meer. Rumah Sakit ini khusus melayani para prajurit.</p>
									</div>
								</div>
                                <div class="row">
                                    <div class="col-md mt-2 mt-md-0">
                                        <p><b>Pada tgl 6 Mei 1950</b> dilakukan serah terima Rumah Sakit Militer Belanda kpd TNI-AD. Pihak Belanda diwakili oleh Kapten dr. Slachten dari pihak TNI-AD diwakili oleh Kapten dr. Moeldjoto.</p>
                                    </div>
									<div class="col-md">
										<img src="../../../images/blog/rst_dulu_2.png" class="img-fluid" alt="">
									</div>
								</div>
                                <br>
							</div>
					...
					<div class="col-lg-3 aside-left mt-5 mt-lg-0">
						...
						<div class="side-block">
							<h3 class="side-block-title">Tentang Kami</h3>
