						...
						<div class="blog-posts">
							<div class="blog-post">
								<div class="blog-post-info">
									<div>
										<h2 class="post-title"><a href="../../../tentang_kami/detail/visimisi">Visi dan Misi</a></h2>
									</div>
								</div>
								...
								<div class="post-teaser">
                                    <h4>Visi</h4>
                                    <p>"Visi Menjadi Rumah Sakit Kebanggaan Prajurit, PNS dan Keluarganya serta masyarakat umum"</p>
                                    <h4>Misi</h4>
                                    <ol>
                                        <li>Mengutamakan pelayanan yang prima</li>
                                        <li>Menungkatakan kualitas SDM disegala bidang</li>
                                        <li>Meningkatkan kualitas sarana & prasarana</li>
                                    </ol>
                                </div>
